...
dependency(2).name='syllable-detection';
dependency(2).chk='sylldet_pitch_autocorr';
dependency(2).url='https://github.com/jmarkow/syllable-detection.git';
dependency(2).basedir='';

dependency(3).name='robofinch';
dependency(3).chk='robofinch_agg_data';
dependency(3).url='https://github.com/jmarkow/robofinch.git';
dependency(3).basedir='';

dependency(4).name='robofinch-agg-scripts';
dependency(4).chk='robofinch_fluolab';
dependency(4).url='https://github.com/jmarkow/robofinch-agg-scripts.git';
dependency(4).basedir='';

dependency(5).name='zftftb';
dependency(5).chk='zftftb_song_clust';
dependency(5).url='https://github.com/jmarkow/zftftb.git';
dependency(5).basedir='';

dependency(6).name='fluolab';
dependency(6).chk='';
dependency(6).url='';
dependency(6).basedir=cur_path;
